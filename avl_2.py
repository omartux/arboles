...
llave = True
while llave == True:
    dato = input("i para insertar, d para borrar, max para maximo y min para minimo, s para search, d para demo, x para salir")
    ...
    if dato == "d":
        ...
        numero = input("datos a buscar ")
        numero = int(numero)
        
        
        numero = arbol.search(numero)
        print (numero)
        print (arbol)
    ...
    if dato == "i":
        ...
        dato = input("datos a insertar: ")
        arbol.insert(dato)
        print (arbol)
        
    if dato == "s":
        
        dato = input("datos a buscar ")
        
 

    if dato == "d":
        dato = input("dato a borrar: ")
        dato = int(dato)
        arbol.delete_value(dato)
        print (arbol)
